    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chargespercentages', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='apps_tenantRecords.charges')),
                ('tenant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='apps_tenantRecords.tenant')),
            ],
        ),
        migrations.CreateModel(
            name='Payment',
            fields=[
                ...
                ('shop', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='payment', to='apps_tenantRecords.shop')),
            ],
        ),
        migrations.CreateModel(
            name='Letter',
            fields=[
                ...
                ('shop', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='letter', to='apps_tenantRecords.shop')),
                ('tenant', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='letter', to='apps_tenantRecords.tenant')),
                ('type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='letter', to='apps_tenantRecords.lettertype')),
            ],
        ),
        migrations.CreateModel(
            name='Invoice',
            fields=[
                ...
                ('shop', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='apps_tenantRecords.shop')),
            ],
        ),
    ]
